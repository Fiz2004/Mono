        ...
        viewModelScope.launch(Dispatchers.Default) {
            ...
            launch {
                categoryRepository.getAllCategoryExpenseForInput()
                    .collectLatest { allCategoryExpense ->
            ...
            launch {
                categoryRepository.getAllCategoryIncomeForInput()
                    .collectLatest { allCategoryIncome ->
                        uiState.value =
                            uiState.value.copy(allCategoryIncome = allCategoryIncome)
                    }
            }

            launch {
                transactionDataSource.allTransactions
