...
data class ReportCategoryViewState(
    ...
    val reportFor: PeriodForReport = PeriodForReport.Month,
    val currency: String = "$",
    ...
    val period
        get() = if (reportFor == PeriodForReport.Month) R.string.this_month else
            R.string.this_week
    ...
    fun getValueReportCategory(
        ...
        val a = if (reportFor == PeriodForReport.Month)
